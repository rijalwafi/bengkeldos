# Aplikasi Penjualan Sparepart motor Dengan Framework CodeIgniter 3 & Template SB Admin 2
...
4. Import data mysql di folder `db/bengkel.sql` ke database milik kalian
5. Untuk login `admin` kalian bisa menggunakan username = `anton` dan password `anton`
6. Untuk login `kasir` kalian bisa menggunakan username = `KSR72` dan password `pandu`
