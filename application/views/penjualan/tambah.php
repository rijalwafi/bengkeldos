...
<body id="page-top">
                                    ...
                                    <form action="<?= base_url('penjualan/proses_tambah') ?>" id="form-tambah" method="POST">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-3">
                                                ...
                                                <input type="text" name="kode_kasir" value="<?= $this->session->login['kode'] ?>" readonly
                                                    class="form-control">
                                            </div>
                                            <div class="form-group col-3">
                                                <label>Nama Kasir</label>
                                                <input type="text" name="nama_kasir" value="<?= $this->session->login['nama'] ?>" readonly
                                                    class="form-control">
                                            </div>
                                            <div class="form-group col-2">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-2">
                                                ...
                                                <span class="text text-danger"><?=form_error('jumlah')?></span>
                                            </div>
                                            <div class="form-group col-2">
    ...
    $(document).ready(function() {
            ...
            if ($(this).val() == '') reset()
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('input[name="sub_total"]').val($('input[name="jumlah"]').val() * $('input[name="harga_barang"]')
                            .val())
        ...
        $(document).on('click', '#tambah', function(e) {
            ...
            if (parseInt($('input[name="max_hidden"]').val()) <= parseInt(data_keranjang.jumlah)) {
            ...
            } else if (regex.test(data_keranjang.jumlah) == false) {
                alert('masukin jumlah yang bener tod');
                ...
                $.ajax({
                    ...
                    data: data_keranjang,
                    success: function(data) {
                        if ($('select[name="nama_barang"]').val() == data_keranjang.nama_barang) $('option[value="' +
                            data_keranjang.nama_barang + '"]').hide()
                        reset()
