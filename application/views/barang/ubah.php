                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="kode_barang" placeholder="Masukkan Kode Barang" autocomplete="off"
                                                    class="form-control" required value="<?= $barang->kode_barang ?>" maxlength="8" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="satuan"><strong>Kategori</strong></label>
                                                <input type="text" name="kategori" id="kategori" value="<?=$barang->kategori?>" readonly
                                                    class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="nama_barang"><strong>Nama Barang</strong></label>
                                                <input type="text" name="nama_barang" placeholder="Masukkan Nama Barang" autocomplete="off"
                                                    class="form-control" required value="<?= $barang->nama_barang ?>">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6" <?=$barang->kategori=='jasa'?'hidden':''?>>
                                                ...
                                                <input type="number" name="harga_beli" id="harga_beli" placeholder="Masukkan Harga Beli"
                                                    autocomplete="off" class="form-control" required value="<?= $barang->harga_beli ?>">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label
                                                    for="harga_jual"><strong><?=$barang->kategori=='jasa'?'Harga Jasa':'harga Jual'?></strong></label>
                                                <input type="number" name="harga_jual" placeholder="Masukkan Harga Jual" autocomplete="off"
                                                    class="form-control" required value="<?= $barang->harga_jual ?>">
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="satuan" id="satuan" class="form-control" <?= $barang->kategori=='jasa'?'disabled':'' ?>
                                                    required>
